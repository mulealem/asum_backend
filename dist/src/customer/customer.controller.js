...
__decorate([
    (0, common_1.Post)(),
    (0, common_1.UsePipes)(new zod_validation_pipe_1.ZodValidationPipe(create_customer_dto_1.CreateCustomerSchema)),
...
__decorate([
    ...
    (0, common_1.UsePipes)(new zod_validation_pipe_1.ZodValidationPipe(customer_entity_1.CustomerParameterSchema)),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
