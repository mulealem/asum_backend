...
export declare class ProductVariantAttributeService {
    private prisma;
    constructor(prisma: PrismaService);
    create(data: CreateProductVariantAttributeDto): import(".prisma/client").Prisma.Prisma__ProductVariantAttributeClient<{
        value: string;
    ...
    disable(id: string, disabledById: string): import(".prisma/client").Prisma.Prisma__ProductVariantAttributeClient<{
        value: string;
        enabledById: string | null;
        id: string;
        createdAt: Date;
