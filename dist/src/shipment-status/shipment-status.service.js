...
exports.ShipmentStatusService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../prisma.service");
let ShipmentStatusService = class ShipmentStatusService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    create(data) {
...
exports.ShipmentStatusService = ShipmentStatusService;
exports.ShipmentStatusService = ShipmentStatusService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], ShipmentStatusService);
//# sourceMappingURL=shipment-status.service.js.map