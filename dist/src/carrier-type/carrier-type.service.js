...
exports.CarrierTypeService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../prisma.service");
let CarrierTypeService = class CarrierTypeService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    create(data) {
        return this.prisma.carrierType.create({ data });
    }
    findAll() {
        return this.prisma.carrierType.findMany({});
    }
    filter(query) {
    ...
    findOne(id) {
        return this.prisma.carrierType.findUnique({ where: { id } });
    }
    update(id, updateCarrierTypeDto) {
        return this.prisma.carrierType.update({
            where: { id },
            data: updateCarrierTypeDto,
        });
    }
    enable(id) {
        return this.prisma.carrierType.update({
...
exports.CarrierTypeService = CarrierTypeService;
exports.CarrierTypeService = CarrierTypeService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], CarrierTypeService);
//# sourceMappingURL=carrier-type.service.js.map