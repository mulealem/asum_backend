...
exports.ShipmentItemStatusOptionService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../prisma.service");
let ShipmentItemStatusOptionService = class ShipmentItemStatusOptionService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    create(data) {
...
exports.ShipmentItemStatusOptionService = ShipmentItemStatusOptionService;
exports.ShipmentItemStatusOptionService = ShipmentItemStatusOptionService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], ShipmentItemStatusOptionService);
//# sourceMappingURL=shipment-item-status-option.service.js.map