...
export declare class ProductVariantService {
    ...
    create(data: CreateProductVariantDto): import(".prisma/client").Prisma.Prisma__ProductVariantClient<{
        code: string;
    ...
    disable(id: string, disabledById: string): import(".prisma/client").Prisma.Prisma__ProductVariantClient<{
        code: string;
        enabledById: string | null;
        id: string;
        createdAt: Date;
