...
export declare class SupplierService {
    ...
    create(data: CreateSupplierDto): import(".prisma/client").Prisma.Prisma__SupplierClient<{
        title: string;
    ...
    disable(id: string, disabledById: string): import(".prisma/client").Prisma.Prisma__SupplierClient<{
        title: string;
        abbreviation: string | null;
        description: string | null;
        enabledById: string | null;
